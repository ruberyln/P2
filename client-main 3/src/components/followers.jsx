                                ...
                                return (<ListItem alignItems="flex-start" key={follower._id} >
                                    ...
                                    <ListItemText
                                        ...
                                        secondary={<React.Fragment>
                                            ...
                                            {(user._id !== follower._id) && (user.following.includes(follower._id)) && <HowToRegIcon onClick={() => { unFollowUser(follower._id) }} color = "secondary"/>}
                                            {(user._id !== follower._id) && (!user.following.includes(follower._id)) && < PersonAddAlt1Icon onClick={() => { followUser(follower._id) }} color = "secondary" />}
                                            </Stack>
                                        </React.Fragment>} />
